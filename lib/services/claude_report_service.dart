...
class ClaudeReportService {
  ...
  Stream<String> generateReportStream(
    ...
    final prompt =
        _buildPrompt(analysisJson, locale, exclusionContext, profileContext);
  ...
  String _buildProfileContext(UserProfile? profile) {
    ...
    buffer.writeln('1. Personalize UL threshold warnings by age and sex');
    buffer.writeln('2. Flag drug-supplement interactions based on medications');
    buffer.writeln(
    ...
    buffer.writeln('5. Apply pregnancy/nursing restrictions if applicable');
  ...
  String _buildPrompt(String analysisJson, String locale,
      String exclusionContext, String profileContext) {
    return '''
