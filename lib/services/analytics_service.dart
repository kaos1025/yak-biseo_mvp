...
class AnalyticsService {
  ...
  Future<void> logAppOpen() async {
    ...
    developer.log('Analytics: AppOpen logged',
        name: 'com.example.myapp.analytics');
  }
  ...
  Future<void> logCameraClick() async {
    ...
    developer.log('Analytics: CameraClick logged',
        name: 'com.example.myapp.analytics');
  }
  ...
  Future<void> logGalleryClick() async {
    ...
    developer.log('Analytics: GalleryClick logged',
        name: 'com.example.myapp.analytics');
  }
  ...
  Future<void> logAnalysisResult(bool isSuccess) async {
    ...
    developer.log('Analytics: AnalysisResult logged (Success: $isSuccess)',
        name: 'com.example.myapp.analytics');
  }
}
